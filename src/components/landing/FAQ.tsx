...
const faqs = [
  { q: "كيف أربط واتساب بمسند؟", a: "عملية الربط سهلة وسريعة. سجّل في مسند، اختر 'ربط واتساب'، امسح رمز QR من تطبيق واتساب أعمال، وسيتم الربط تلقائياً في أقل من 5 دقائق." },
  { q: "هل يمكنني تجربة مسند مجاناً؟", a: "نعم! نوفر خطة مجانية تتيح لك تجربة الميزات الأساسية بدون بطاقة ائتمان. يمكنك الترقية في أي وقت عند حاجتك لميزات إضافية." },
  { q: "هل بياناتي آمنة على مسند؟", a: "أمان بياناتك أولويتنا القصوى. نستخدم تشفير AES-256، نلتزم بمعايير GDPR، وجميع البيانات مخزّنة على خوادم آمنة مع نسخ احتياطي يومي." },
  ...
  { q: "هل يعمل مسند مع واتساب العادي أم أعمال فقط؟", a: "مسند يعمل مع واتساب أعمال API الذي يوفر ميزات متقدمة مثل الرسائل التلقائية والقوائم. يمكنك الترقية من واتساب العادي إلى أعمال بسهولة." },
    ...
    <section id="faq" className="section-padding gradient-bg-subtle relative overflow-hidden">
      <div className="container-max relative z-10">
        <div ref={titleRef} className={`text-center mb-14 md:mb-20 ${titleVisible ? "animate-fade-in-up" : "opacity-0"}`}>
          ...
          <p className="section-subtitle mx-auto">إليك أكثر الأسئلة شيوعاً عن مسند. لم تجد إجابتك؟ تواصل معنا مباشرة.</p>
        </div>
