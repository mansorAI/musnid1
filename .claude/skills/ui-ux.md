...
Use the Quick Reference sections above. Stack: **Next.js 16 + Tailwind v4 + shadcn/ui**.

| Scenario | Quick Reference |
|----------|----------------|
| صفحة جديدة | §4 Style + §5 Layout |
| مكوّن تفاعلي (form، modal، button) | §8 Forms & Feedback + §2 Interaction |
| Dark/Light mode | §6 → `color-dark-mode` |
| مراجعة UX | §1 Accessibility + §2 |
| Charts / بيانات | §10 Charts |
| Animation | §7 |
...
| Navigation feels confusing | §9: `nav-hierarchy` + `back-behavior` |
| Layout breaks on mobile | §5: `mobile-first` + `breakpoint-consistency` |
| Performance / jank | §3: `virtualize-lists` + `debounce-throttle` |

### Pre-Delivery Checklist (Web)

- مراجعة §1–§3 (CRITICAL + HIGH) قبل التسليم
- اختبار على 375px
- التحقق من Dark mode contrast بشكل مستقل
